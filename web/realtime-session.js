...
export class RealtimeSession extends EventTarget {
  ...
  #settleInflightUncertain(){for(const id of this.inflight){const settled=this.commands.cancel(id,{status:'uncertain',error:'connection lost before acknowledgement'});if(settled)this.#emit('command',{id,...settled});}this.inflight.clear();}
